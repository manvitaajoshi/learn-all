...
export default function Login() {
    ...
    const adminLogin = () => {
        ...
        ref.on('value', (snapshot) => {
            ...
            for (let id in users) {
                if (users[id].userEmail == emailRef.current.value && users[id].password == passwordRef.current.value) {
                    history.push("/admin");
                }
            }
        })
    ...
    return (
        <>
            ...
            <form class="box1" onSubmit={handleSubmit}>
                ...
                <br /><input type="submit" name="" className="btn1" disabled={loading} value="Login" /><br />
            </form>
            <div  style={{ position: "absolute", top: "350px", right: "330px" }}>
            ...
            <div>
                <Link to="/forgot-password" style={{ color: "black", position: "absolute", top: "450px", right: "380px" }}>Forgot Password?</Link>
            </div>
            <div style={{ position: "absolute", top: "490px", right: "330px" }}>
